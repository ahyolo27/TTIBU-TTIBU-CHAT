...
import com.ttibuttibu.chat.coreapi.domain.chat.dto.ChatSseEvent;
import com.ttibuttibu.chat.coreapi.domain.chat.entity.Chat;
import com.ttibuttibu.chat.coreapi.domain.chat.enums.ChatSseEventType;
import com.ttibuttibu.chat.coreapi.domain.chat.enums.ChatType;
import com.ttibuttibu.chat.coreapi.domain.chat.repository.ChatRepository;
import com.ttibuttibu.chat.coreapi.domain.group.entity.Group;
import com.ttibuttibu.chat.coreapi.domain.group.repository.GroupRepository;
import com.ttibuttibu.chat.coreapi.domain.key.entity.Key;
import com.ttibuttibu.chat.coreapi.domain.key.repository.KeyRepository;
import com.ttibuttibu.chat.coreapi.domain.key.service.KeyService;
...
import com.ttibuttibu.chat.coreapi.domain.room.dto.*;
import com.ttibuttibu.chat.coreapi.domain.room.entity.Room;
import com.ttibuttibu.chat.coreapi.domain.room.repository.RoomRepository;
...
public class RoomServiceImpl implements RoomService {
    ...
    private String bestAvailableGroupText(Long groupId) {
        ...
        return chatRepository.findAllByGroup_GroupUidAndChatType(groupId, com.ttibuttibu.chat.coreapi.domain.chat.enums.ChatType.GROUP)
                .stream()
                .map(c -> {
